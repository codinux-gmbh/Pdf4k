...
open class PdfDocument(structure: PdfStructure, objectParser: PdfObjectParser) {
    ...
    val documentInfo: PdfDict? // TODO: map object
    ...
    init {
        ...
        this.documentInfo = referenceResolver.lookupDict(trailerInfo.info ?: catalog.get(PdfName.Info)) // sometimes the /Info dictionary resides in /Catalog dict
